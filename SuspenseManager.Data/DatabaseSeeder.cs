...
public static class DatabaseSeeder
{
    ...
    private static async Task SeedCompaniesAsync(SuspenseManagerDbContext db)
    {
        var defs = new[]
        {
            ...
            new { Code = "UMG",     Legal = "Universal Music Group",    Short = "UMG",        Bank = "Deutsche Bank", Inn = "",            Bic = "",            Country = "US", Phone = "+12125551000",  Addr = "1755 Broadway, New York, NY 10019, USA"   },
            new { Code = "SONY",    Legal = "Sony Music Entertainment", Short = "Sony Music", Bank = "JP Morgan",     Inn = "",            Bic = "",            Country = "US", Phone = "+12125552000",  Addr = "25 Madison Ave, New York, NY 10010, USA"  },
            new { Code = "WMG",     Legal = "Warner Music Group",       Short = "Warner",     Bank = "Citibank",      Inn = "",            Bic = "",            Country = "US", Phone = "+12125553000",  Addr = "1633 Broadway, New York, NY 10019, USA"   },
            new { Code = "BMG",     Legal = "BMG Rights Management",    Short = "BMG",        Bank = "Commerzbank",   Inn = "",            Bic = "",            Country = "DE", Phone = "+493015551000", Addr = "Weidestraße 122b, 22083 Hamburg, DE"     },
            new { Code = "PIAS",    Legal = "PIAS Entertainment Group", Short = "PIAS",       Bank = "ING Bank",      Inn = "",            Bic = "",            Country = "BE", Phone = "+3225551000",   Addr = "Rue de la Loi 200, 1040 Brussels, BE"    },
            new { Code = "BLIEVE",  Legal = "Believe Digital",          Short = "Believe",    Bank = "BNP Paribas",   Inn = "",            Bic = "",            Country = "FR", Phone = "+3315551000",   Addr = "24 Rue Toulouse Lautrec, 75017 Paris, FR" },
            new { Code = "KONTOR",  Legal = "Kontor Records",           Short = "Kontor",     Bank = "Deutsche Bank", Inn = "",            Bic = "",            Country = "DE", Phone = "+494015551000", Addr = "Valentinskamp 70, 20355 Hamburg, DE"     },
        };
